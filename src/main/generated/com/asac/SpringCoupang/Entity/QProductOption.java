...
public class QProductOption extends EntityPathBase<ProductOption> {
    ...
    private static final long serialVersionUID = 448731086L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QProductOption productOption = new QProductOption("productOption");

    public final NumberPath<java.math.BigDecimal> additionalPrices = createNumber("additionalPrices", java.math.BigDecimal.class);

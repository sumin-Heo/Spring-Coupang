...
public class ProductDetailRepository {
    ...
    public ProductDetail findById(Long id) {
        String sql = "SELECT id, name, description, price FROM product_details WHERE id = ?";
    ...
    public int insertProductDetail(ProductDetail productDetail) {
        String sql = "INSERT INTO product_details (name, description, price) VALUES (?, ?, ?)";
    ...
    public int updateProductDetail(ProductDetail productDetail) {
        String sql = "UPDATE product_details SET name = ?, description = ?, price = ? WHERE id = ?";
